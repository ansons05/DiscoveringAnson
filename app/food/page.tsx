...
const meals: Meal[] = [
  ...
  { id: 3, restaurant: "Cafe", item: "Matcha Latte", rating: 9, notes: "Heavy earthy matcha flavor, very reasonable portion size.", photoUrl: "/images/matcha_latte.png" },
  { id: 4, restaurant: "Ginger and Soy", item: "Pad Thai", rating: 9, notes: "Sweet, salty, tangy flavor, perfect portion size.", photoUrl: "/images/pad_thai.jpg" },
  ...
  { id: 12, restaurant: "Sazon", item: "Sazon Bowl", rating: 8.5, notes: "Filling with great variety of ingredients, highly customizable.", photoUrl: "/images/sazon_bowl.png" },
  ...
  { id: 16, restaurant: "Ginger and Soy", item: "Seoul Bowl", rating: 8, notes: "Tender meat, great sauce, cohesive veggies.", photoUrl: "/images/seoul_bowl.png" },
  ...
  { id: 19, restaurant: "J.B.'s Roast & Chops", item: "Black and Blue Burger", rating: 8, notes: "Patty thick, bleu cheese present, arugula and onion just added volume.", photoUrl: "/images/black_blue_burger.png" },
  ...
  { id: 21, restaurant: "The Devil's Krafthouse", item: "Vanilla Milkshake", rating: 8, notes: "Thick and creamy, vanilla taste prominent.", photoUrl: "/images/vanilla_milkshake.png" },
  { id: 22, restaurant: "The Devil's Krafthouse", item: "Mushroom and Swiss Burger", rating: 8, notes: "Solid overall, could be juicier.", photoUrl: "/images/mushroom_swiss.png" },
  { id: 23, restaurant: "The Devil's Krafthouse", item: "$5 Grilled Cheese", rating: 8, notes: "Crispy and filled well.", photoUrl: "/images/grilled_cheese.png" },
  ...
  { id: 26, restaurant: "The Devil's Krafthouse", item: "Cappuccino Chip Milkshake", rating: 7.5, notes: "Creamy but chocolate chips pooled at bottom.", photoUrl: "/images/cappuccino_chip_milkshake.png" },
  ...
  { id: 28, restaurant: "J.B.'s Roast & Chops", item: "8oz Steak", rating: 7, notes: "Large portion but somewhat dry.", photoUrl: "/images/8oz_steak.png" },
  ...
  { id: 31, restaurant: "The Devil's Krafthouse", item: "Flank Steak French Dip", rating: 7, notes: "Underfilled, french dip slightly bland, seasoned well.", photoUrl: "/images/flank_steak_dip.png" },
